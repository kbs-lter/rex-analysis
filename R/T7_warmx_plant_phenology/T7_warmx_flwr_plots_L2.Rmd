...
All years
```{r}
# need to subset by Julian date bc 2022 is not finished yet - last julian date of data collected for 2022 at this time is 2010
...
ggplot(Trpr_noninsect_21, aes(x = Subplot_Descriptions, y = min_julian, fill = Subplot_Descriptions)) +
        geom_boxplot(color = "black", outlier.shape = NA) +
        labs(x = "Treatment", y = "2021 Average Julian Date of First Flower", fill = "Subplot_Descriptions") +
        geom_jitter(shape=16, position=position_jitter(0.2)) +
        scale_fill_manual(values = c("ambient" = "darkblue", "drought" = "gray58", "irrigated_control" =
                                             "deepskyblue", "warmed" = "red2", "warmed_drought" = "darkred")) +
        theme(legend.text = element_text(size=16),
