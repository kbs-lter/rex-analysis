...
physeq_tree <- qza_to_phyloseq(
        tree = "/Users/moriahyoung/Downloads/16S-2021-fasttree-rooted-tree.qza"
        )
physeq_tree
...
plot_richness(ps.rarefied, x="Drought", measures=c("Observed"), color = "Subplot_Descriptions") + 
        geom_boxplot() + 
        labs(y = "Observed OTUs", x = "Time of Sampling") +
        facet_grid(.~Subplot_Descriptions, scale="free", labeller = as_labeller(treatment_names)) +
        scale_colour_manual(values = c("ambient" = "darkblue", "drought" = "gray58", 
...
plot_richness(ps.rarefied, x="Drought", measures=c("Shannon"), color = "Subplot_Descriptions") + 
        geom_boxplot() + 
...
plot_ordination(ps.rarefied, ordination, color="Subplot_Descriptions", shape = "Drought") + 
        ...
        scale_color_discrete(name = "Subplot Descriptions", 
