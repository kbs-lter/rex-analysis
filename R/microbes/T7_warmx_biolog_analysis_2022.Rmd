...
Richness <- rowSums(biologHr168[,-c(1:6)]>0)

# Second, calculate shannon diversity 
Shannon <- diversity(biologHr168[,-c(1:6)], index = "shannon")

# Third, calculate Average Well Color Development (mean color change across all 31 substrates)
AWCD <- apply(biologHr168[,-c(1:6)],1,mean)

# merge diversity data with SampleID_Hour for 168hr
biologHr168diversity <- cbind(biologHr168[1:6], Richness, Shannon, AWCD)
...
```{r}
# this doesn't run anymore - need to look into, need to add column to line #293
