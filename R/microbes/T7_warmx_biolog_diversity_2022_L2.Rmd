...
# Moriah note - I think here, we will want to preserve all of these columns, so maybe don't remove                 
...
# might need to come back to this - do we need to 
```{r}
...
renyi_function <- function(data) {
  ...
  AWCD <- apply(data[,-c(1:8)], 1, mean)
  biolog.hill.AWCD <- cbind(data[1:8], biolog.hill, AWCD)
}
