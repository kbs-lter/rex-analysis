...
exp(1.46130)-exp(1.46130-0.31131) # -2.149712 - drought plants weighed ~2.1 g less than warmed
...
# re-set the reference level for diff. comparisons
biomass <- within(biomass, Galling_Status <- relevel(factor(Galling_Status), ref = "Galled"))
# rerun model
m1 <- lmer(log_biomass ~ Climate_Treatment * Galling_Status + (1|Rep/Footprint/Subplot) + (1|Year), data = biomass, REML=F)
summary(m1)
anova(m1)
...
exp(1.42062)-exp(1.42062-0.04069) # 0.1650629 - galled plants weighed 0.17 g more than non-galled plants
