...
# Gall average plot
png("heights_gall.png", units="in", width=5, height=5, res=300)
...
# Boxplot
png("gall_diameter.png", units="in", width=6, height=5, res=300)
...
png("gall_height.png", units="in", width=6, height=5, res=300)
...
# ggplot version
png("dia_corr.png", units="in", width=5, height=5, res=300)
...
# ggplot version
png("height_corr.png", units="in", width=5, height=5, res=300)
