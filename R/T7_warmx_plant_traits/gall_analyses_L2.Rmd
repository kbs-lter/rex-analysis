...
m5l <- lmer(lph ~ treatment * gall_present + (1|rep), data=galls3, REML=F)
AICctab(m1l, m2l, m3l, m4l, m5l, weights=T)
# Model 1 fits the best but it makes sense that there is an interaction between treatment and gall presence
summ(m5l)
summary(m5l)
# Post hoc test to compare different levels
emmeans(m5l, list(pairwise ~ treatment), adjust = "tukey")
emmeans(m5l, list(pairwise ~ treatment * gall_present), adjust = "tukey")
...
AICctab(g.m1, g.m2, weights=T)
# Model 1 fits the best
summary(g.m1)

# Post hoc test to compare different levels
emmeans(g.m1, list(pairwise ~ treatment), adjust = "tukey")
```
...
AICctab(h.m1, h.m2, weights=T)
# Model 1 fits the best
summary(h.m1)

# Post hoc test to compare different levels
emmeans(h.m1, list(pairwise ~ treatment), adjust = "tukey")
```
